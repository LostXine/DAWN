...
class ImagineToAct(torch.nn.Module):
    def __init__(self, 
        magine_model=None, 
        action_model=None, 
        imagine_model_weights=None, 
        use_flow=True,
        reset_action_steps=10,
    ):
        super().__init__()
        ...
        self.reset_action_steps = reset_action_steps
    ...
    def reset(self):
        ...
        self.cnt = self.reset_action_steps
    ...
    def forward(self, batch_data, gen_flow=True, split="train", **kwargs):
        # Imagine  
        ...
        with torch.no_grad():
            ...
            # if not self.training or random.random() < 0.5:
                if split != "train" or gen_flow or random.random() < 0.5:
