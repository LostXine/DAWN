...
if __name__ == "__main__":
    # The start method logic remains the same
    # try:
    ...
    builder = tfds.builder_from_directory(
        builder_dir="/nfs/bigcornea/add_disk1/robotics/open-x/droid_100/1.0.0"
    )
    ds = builder.as_dataset(split='train')
    # output_dir = '/nfs/bigcornea/add_disk2/nero/datasets/robotics/droid/opt/validation'
    output_dir = '/home/nero/Robotics/DAWN/data/droid_100_3'
