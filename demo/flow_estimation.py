...
config = {
    "_target_" : "dawn.models.system2.ldm.LatentMotionEstimation",
    "flow_to_rgb" : False,
    "use_cfg" : False,
    "use_interval" : True,
}
...
weights = "../outputs_bigcornea/DAWN_stage_1/2025-06-26_16-41-53/checkpoints/model_0019000.pth"
...
def process_images_and_flow(image_path_input: str, input_text: str, k_value: int):
    """
